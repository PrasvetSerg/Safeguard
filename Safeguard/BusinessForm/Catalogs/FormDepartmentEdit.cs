...
{
    public partial class FormDepartmentEdit : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FormDepartmentEdit(ServiceTypes.ActionType actionType = ActionType.None, int recordId = -1, int parentId = -1, int relativePosition = 999)
        {
        ...
        private void UpdateDataOnForm()
        {
            ...
            if (this.recordId > 0)
            {
                ...
                DataTable dataTable = DBConnection.SqlQuery.ReadData(this, string.Format("dtr_department_get 'by_department_id',{0}", this.RecordId));

                if (dataTable != null && dataTable.Rows.Count > 0)
                {
                    this.idTextEdit.Text = dataTable.Rows[0]["department_id"].ToString();
                    //this.parentRecordId = (dataTable.Rows[0]["parent_department_id"] == DBNull.Value ? -1 : (int)dataTable.Rows[0]["parent_department_id"]);
                    this.nameTextEdit.Text = dataTable.Rows[0]["department_name"].ToString();
        ...
        private void ActivateControl()
        {
            ...
            {
                this.Text = "Регистрация нового производства";
            ...
            {
                this.Text = "Редактирование информации о производства";
        ...
        private bool SaveData()
        {
            ...
            string query = string.Concat("dtr_department_set"
                ...
                , ",@department_id=" + this.RecordId
                //, ",@parent_department_id=" + DBConnection.SqlQuery.IdToDbId(this.parentRecordId)
                , ",@department_name=" + DBConnection.SqlQuery.StrToDbString(this.nameTextEdit.Text.Trim())
            ...
            try
            {
                ...
                if (dataTable.Rows.Count == 1)
                {
                    ...
                    this.recordId = (int)dataTable.Rows[0]["department_id"];
                }
            }
