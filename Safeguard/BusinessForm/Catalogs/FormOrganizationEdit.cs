...
{
    public partial class FormOrganizationEdit : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FormOrganizationEdit(ServiceTypes.ActionType actionType = ActionType.None, int recordId = -1, int parentId = -1, int relativePosition = 999)
        {
        ...
        private void UpdateDataOnForm()
        {
            ...
            if (this.recordId > 0)
            {
                ...
                DataTable dataTable = DBConnection.SqlQuery.ReadData(this, string.Format("dtr_organization_get 'by_organization_id',{0}", this.RecordId));

                if (dataTable != null && dataTable.Rows.Count > 0)
                {
                    this.idTextEdit.Text = dataTable.Rows[0]["organization_id"].ToString();
                    this.nameTextEdit.Text = dataTable.Rows[0]["organization_name"].ToString();
        ...
        private void ActivateControl()
        {
            ...
            {
                this.Text = "Регистрация новой организации";
            ...
            {
                this.Text = "Редактирование информации о организации";
        ...
        private bool SaveData()
        {
            ...
            string query = string.Concat("dtr_organization_set"
                , " @command=" + DBConnection.SqlQuery.ActionTypeToDbString(this.actionType)
                , ",@organization_id=" + this.RecordId
                , ",@organization_name=" + DBConnection.SqlQuery.StrToDbString(this.nameTextEdit.Text.Trim())
            ...
            try
            {
                ...
                if (dataTable.Rows.Count == 1)
                {
                    ...
                    this.recordId = (int)dataTable.Rows[0]["organization_id"];
                }
            }
