...
{
    public partial class FormReportFromToDateByOrganization : DevExpress.XtraEditors.XtraForm
    {
        public FormReportFromToDateByOrganization()
        {
            InitializeComponent();
        }
        ...
        public int OrganizationId
        {
            get
            {
                return (int)(this.organizationLookUpEdit.EditValue ?? -1);
            }
        }
        ...
        private void InitControl()
        {
            ...
            DataTable dataTable = DBConnection.SqlQuery.ReadData(this, string.Format("dtr_organization_get 'all_view'"));
            if (dataTable != null)
            {
                this.organizationLookUpEdit.Properties.DisplayMember = "organization_name";
                this.organizationLookUpEdit.Properties.ValueMember = "organization_id";
                this.organizationLookUpEdit.Properties.DataSource = dataTable;
            }
            else
            {
        ...
        private bool IsInputedDataValid()
        {
            ...
            if (isInputedDataValid == true && this.organizationLookUpEdit.EditValue == null)
            {
                isInputedDataValid = false;
                DevExpress.XtraEditors.XtraMessageBox.Show(this, "Задайте организацию", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
