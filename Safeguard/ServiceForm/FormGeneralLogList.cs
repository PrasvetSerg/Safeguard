...
{
    public partial class FormGeneralLogList : DevExpress.XtraEditors.XtraForm
    {
        readonly string idFieldName = "general_log_id";
                
        bool isSelectMode;
        int selectedRecordId;
        DataTable dataTable;

        public FormGeneralLogList()
        {
        ...
        public FormGeneralLogList(int selectedRecordId)
        {
        ...
        private void UpdateDataOnForm()
        {
            ...
            DBConnection.SqlQuery.ReadData(this, this.dataTable, "usp_general_log_get 'all_view',''");
